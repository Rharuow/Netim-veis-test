...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center  p-1 border-b-2 border-[#e1e5e9] w-full text-muted-foreground",
      className
    )}
    {...props}
  />
